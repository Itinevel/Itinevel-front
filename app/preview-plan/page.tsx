...
import LocationComponent from '@/components/view/preview-location';
import TransportComponent from '@/components/view/preview-transport';
...
import GalleryPopup from '@/components/utils/gallery-popup';
